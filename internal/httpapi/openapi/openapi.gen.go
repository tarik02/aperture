...
// Defines values for BrowserCookieSameSite.
const (
	BrowserCookieSameSiteLax    BrowserCookieSameSite = "Lax"
	BrowserCookieSameSiteNone   BrowserCookieSameSite = "None"
	BrowserCookieSameSiteStrict BrowserCookieSameSite = "Strict"
)

// Valid indicates whether the value is a known member of the BrowserCookieSameSite enum.
func (e BrowserCookieSameSite) Valid() bool {
	switch e {
	case BrowserCookieSameSiteLax:
		return true
	case BrowserCookieSameSiteNone:
		return true
	case BrowserCookieSameSiteStrict:
		return true
	default:
		return false
	}
...
// Defines values for InitialBrowserControlSelectionDirection.
const (
	InitialBrowserControlSelectionDirectionBackward InitialBrowserControlSelectionDirection = "backward"
	InitialBrowserControlSelectionDirectionForward  InitialBrowserControlSelectionDirection = "forward"
	InitialBrowserControlSelectionDirectionNone     InitialBrowserControlSelectionDirection = "none"
)

// Valid indicates whether the value is a known member of the InitialBrowserControlSelectionDirection enum.
func (e InitialBrowserControlSelectionDirection) Valid() bool {
	switch e {
	case InitialBrowserControlSelectionDirectionBackward:
		return true
	case InitialBrowserControlSelectionDirectionForward:
		return true
	case InitialBrowserControlSelectionDirectionNone:
		return true
	default:
		return false
	}
...
// Defines values for InitialBrowserDocumentStateVersion.
const (
	N1 InitialBrowserDocumentStateVersion = 1
)

// Valid indicates whether the value is a known member of the InitialBrowserDocumentStateVersion enum.
func (e InitialBrowserDocumentStateVersion) Valid() bool {
	switch e {
	case N1:
		return true
	default:
...
// Defines values for InitialIndexedDBIndexKeyPathKind.
const (
	InitialIndexedDBIndexKeyPathKindArray  InitialIndexedDBIndexKeyPathKind = "array"
	InitialIndexedDBIndexKeyPathKindString InitialIndexedDBIndexKeyPathKind = "string"
)

// Valid indicates whether the value is a known member of the InitialIndexedDBIndexKeyPathKind enum.
func (e InitialIndexedDBIndexKeyPathKind) Valid() bool {
	switch e {
	case InitialIndexedDBIndexKeyPathKindArray:
		return true
	case InitialIndexedDBIndexKeyPathKindString:
		return true
	default:
		return false
	}
...
// Defines values for InitialIndexedDBKeyPathKind.
const (
	InitialIndexedDBKeyPathKindArray  InitialIndexedDBKeyPathKind = "array"
	InitialIndexedDBKeyPathKindNone   InitialIndexedDBKeyPathKind = "none"
	InitialIndexedDBKeyPathKindString InitialIndexedDBKeyPathKind = "string"
)

// Valid indicates whether the value is a known member of the InitialIndexedDBKeyPathKind enum.
func (e InitialIndexedDBKeyPathKind) Valid() bool {
	switch e {
	case InitialIndexedDBKeyPathKindArray:
		return true
	case InitialIndexedDBKeyPathKindNone:
		return true
	case InitialIndexedDBKeyPathKindString:
		return true
	default:
		return false
	}
...
// Defines values for ProxyConfigUpstream.
const (
	ProxyConfigUpstreamDirect ProxyConfigUpstream = "direct"
	ProxyConfigUpstreamProxy  ProxyConfigUpstream = "proxy"
	ProxyConfigUpstreamTunnel ProxyConfigUpstream = "tunnel"
)

// Valid indicates whether the value is a known member of the ProxyConfigUpstream enum.
func (e ProxyConfigUpstream) Valid() bool {
	switch e {
	case ProxyConfigUpstreamDirect:
		return true
...
// Defines values for SessionProxyLegacyUpstream.
const (
	SessionProxyLegacyUpstreamDirect SessionProxyLegacyUpstream = "direct"
	SessionProxyLegacyUpstreamProxy  SessionProxyLegacyUpstream = "proxy"
	SessionProxyLegacyUpstreamTunnel SessionProxyLegacyUpstream = "tunnel"
)

// Valid indicates whether the value is a known member of the SessionProxyLegacyUpstream enum.
func (e SessionProxyLegacyUpstream) Valid() bool {
	switch e {
	case SessionProxyLegacyUpstreamDirect:
		return true
	case SessionProxyLegacyUpstreamProxy:
		return true
	case SessionProxyLegacyUpstreamTunnel:
		return true
	default:
		return false
	}
...
// Defines values for UpdateProxyConfigUpstream.
const (
	UpdateProxyConfigUpstreamDirect UpdateProxyConfigUpstream = "direct"
	UpdateProxyConfigUpstreamProxy  UpdateProxyConfigUpstream = "proxy"
	UpdateProxyConfigUpstreamTunnel UpdateProxyConfigUpstream = "tunnel"
)

// Valid indicates whether the value is a known member of the UpdateProxyConfigUpstream enum.
func (e UpdateProxyConfigUpstream) Valid() bool {
	switch e {
	case UpdateProxyConfigUpstreamDirect:
		return true
	case UpdateProxyConfigUpstreamProxy:
		return true
	case UpdateProxyConfigUpstreamTunnel:
		return true
	default:
		return false
	}
...
// BrowserCookieSameSite defines model for BrowserCookieSameSite.
type BrowserCookieSameSite string

// BrowserStorageEntry defines model for BrowserStorageEntry.
type BrowserStorageEntry struct {
	Name string `json:"name"`

	// Value Browser storage value. Never log this field.
...
type CreateSessionInput struct {
	...
	// InitialTargets Browser targets that replace the browser's startup page after storage import. Result order follows input order; opener dependencies may be created first.
	InitialTargets *[]InitialBrowserTarget `json:"initialTargets,omitempty"`

	// Label Optional operator-facing label for the session.
	Label *string `json:"label,omitempty"`

	// Proxy Session egress proxy configuration. Rules are checked in order and the first match routes the connection; unmatched connections go direct, and unmatched `localhost` stays on the session host. Omitted for direct egress.
	Proxy *ProxyConfig `json:"proxy,omitempty"`

	// StorageState Profile-scoped browser storage imported before initial browser targets are opened.
	StorageState *InitialBrowserStorageState `json:"storageState,omitempty"`
...
// InitialBrowserContentEditableState defines model for InitialBrowserContentEditableState.
type InitialBrowserContentEditableState struct {
	Html string `json:"html"`

	// Locator Semantic element identity with a structural fallback. It is not a CSS selector.
	Locator InitialBrowserElementLocator `json:"locator"`
}

// InitialBrowserControlSelection defines model for InitialBrowserControlSelection.
type InitialBrowserControlSelection struct {
	Direction InitialBrowserControlSelectionDirection `json:"direction"`
	End       int                                     `json:"end"`
	Start     int                                     `json:"start"`
}

// InitialBrowserControlSelectionDirection defines model for InitialBrowserControlSelection.Direction.
type InitialBrowserControlSelectionDirection string

// InitialBrowserControlState defines model for InitialBrowserControlState.
type InitialBrowserControlState struct {
	Checked *bool `json:"checked,omitempty"`

	// Locator Semantic element identity with a structural fallback. It is not a CSS selector.
	Locator         InitialBrowserElementLocator    `json:"locator"`
	SelectedIndices *[]int                          `json:"selectedIndices,omitempty"`
	Selection       *InitialBrowserControlSelection `json:"selection,omitempty"`
	Value           string                          `json:"value"`
}

// InitialBrowserCookie Cookie imported into the new browser profile.
type InitialBrowserCookie struct {
	Domain string `json:"domain"`

	// Expires Unix timestamp in seconds. Omit for a session cookie.
	Expires *float32 `json:"expires,omitempty"`

	// HostOnly Scope the cookie to exactly `domain`, without subdomains. `domain` must then be a plain hostname.
	HostOnly     *bool                             `json:"hostOnly,omitempty"`
	HttpOnly     *bool                             `json:"httpOnly,omitempty"`
	Name         string                            `json:"name"`
	PartitionKey *InitialBrowserCookiePartitionKey `json:"partitionKey,omitempty"`
	Path         string                            `json:"path"`
	SameSite     *BrowserCookieSameSite            `json:"sameSite,omitempty"`
	Secure       *bool                             `json:"secure,omitempty"`

	// Value Cookie value. Never log this field.
	Value string `json:"value"`
}

// InitialBrowserCookiePartitionKey defines model for InitialBrowserCookiePartitionKey.
type InitialBrowserCookiePartitionKey struct {
	HasCrossSiteAncestor *bool  `json:"hasCrossSiteAncestor,omitempty"`
	TopLevelSite         string `json:"topLevelSite"`
}

// InitialBrowserDocumentSelection defines model for InitialBrowserDocumentSelection.
type InitialBrowserDocumentSelection struct {
	Anchor InitialBrowserSelectionEndpoint `json:"anchor"`
	Focus  InitialBrowserSelectionEndpoint `json:"focus"`
}

// InitialBrowserDocumentState Sensitive top-document state replayed during initial navigation.
type InitialBrowserDocumentState struct {
	ContentEditables []InitialBrowserContentEditableState `json:"contentEditables"`
	Controls         []InitialBrowserControlState         `json:"controls"`

	// Focus Semantic element identity with a structural fallback. It is not a CSS selector.
	Focus *InitialBrowserElementLocator `json:"focus,omitempty"`

	// HistoryState JSON-encoded structured-clone history state.
	HistoryState    *string                               `json:"historyState,omitempty"`
	ScrollPositions []InitialBrowserElementScrollPosition `json:"scrollPositions"`
	Selection       *InitialBrowserDocumentSelection      `json:"selection,omitempty"`
	Version         InitialBrowserDocumentStateVersion    `json:"version"`
	WindowName      *string                               `json:"windowName,omitempty"`
}

// InitialBrowserDocumentStateVersion defines model for InitialBrowserDocumentState.Version.
type InitialBrowserDocumentStateVersion int

// InitialBrowserElementLocator Semantic element identity with a structural fallback. It is not a CSS selector.
type InitialBrowserElementLocator struct {
	AriaLabel    *string                         `json:"ariaLabel,omitempty"`
	Autocomplete *string                         `json:"autocomplete,omitempty"`
	Id           *string                         `json:"id,omitempty"`
	InputType    *string                         `json:"inputType,omitempty"`
	Name         *string                         `json:"name,omitempty"`
	Path         []InitialBrowserElementPathStep `json:"path"`
	Placeholder  *string                         `json:"placeholder,omitempty"`
	Tag          string                          `json:"tag"`
}

// InitialBrowserElementPathStep defines model for InitialBrowserElementPathStep.
type InitialBrowserElementPathStep struct {
	Index int    `json:"index"`
	Tag   string `json:"tag"`
}

// InitialBrowserElementScrollPosition defines model for InitialBrowserElementScrollPosition.
type InitialBrowserElementScrollPosition struct {
	// Locator Semantic element identity with a structural fallback. It is not a CSS selector.
	Locator InitialBrowserElementLocator `json:"locator"`
	X       float32                      `json:"x"`
	Y       float32                      `json:"y"`
...
// InitialBrowserScrollPosition defines model for InitialBrowserScrollPosition.
type InitialBrowserScrollPosition struct {
	X float32 `json:"x"`
	Y float32 `json:"y"`
}

// InitialBrowserSelectionEndpoint defines model for InitialBrowserSelectionEndpoint.
type InitialBrowserSelectionEndpoint struct {
	// Locator Semantic element identity with a structural fallback. It is not a CSS selector.
	Locator  InitialBrowserElementLocator `json:"locator"`
...
// InitialBrowserStorageState Profile-scoped browser storage imported before initial browser targets are opened.
type InitialBrowserStorageState struct {
	Cookies []InitialBrowserCookie `json:"cookies"`
	Origins []InitialStorageOrigin `json:"origins"`
}

// InitialBrowserTarget HTTP page and target-scoped state opened during session creation.
type InitialBrowserTarget struct {
	// Active Select this target for the first connected session client. At most one target may be active.
	Active *bool `json:"active,omitempty"`

	// DocumentState Sensitive top-document state replayed during initial navigation.
	DocumentState *InitialBrowserDocumentState `json:"documentState,omitempty"`

	// OpenerTargetIndex Index of another initial target that opened this target.
	OpenerTargetIndex *int                          `json:"openerTargetIndex,omitempty"`
	Scroll            *InitialBrowserScrollPosition `json:"scroll,omitempty"`

	// SessionStorage Per-origin session storage installed in target frames before page scripts execute.
...
// InitialCacheStorageCache defines model for InitialCacheStorageCache.
type InitialCacheStorageCache struct {
	Entries []InitialCacheStorageEntry `json:"entries"`
	Name    string                     `json:"name"`
}

// InitialCacheStorageEntry defines model for InitialCacheStorageEntry.
type InitialCacheStorageEntry struct {
	// RequestHeaders Arbitrary string key-value metadata. Tag-writing operations additionally reject blank keys and blank values.
	RequestHeaders StringMap `json:"requestHeaders"`
	ResponseBody   []byte    `json:"responseBody"`

	// ResponseHeaders Arbitrary string key-value metadata. Tag-writing operations additionally reject blank keys and blank values.
	ResponseHeaders    StringMap `json:"responseHeaders"`
	ResponseStatus     int       `json:"responseStatus"`
	ResponseStatusText string    `json:"responseStatusText"`
	Url                string    `json:"url"`
}

// InitialIndexedDBDatabase defines model for InitialIndexedDBDatabase.
...
// InitialIndexedDBIndex defines model for InitialIndexedDBIndex.
type InitialIndexedDBIndex struct {
	// KeyPath Index key path. String paths contain one value; array paths contain at least one.
	KeyPath    InitialIndexedDBIndexKeyPath `json:"keyPath"`
	MultiEntry bool                         `json:"multiEntry"`
	Name       string                       `json:"name"`
	Unique     bool                         `json:"unique"`
}

// InitialIndexedDBIndexKeyPath Index key path. String paths contain one value; array paths contain at least one.
type InitialIndexedDBIndexKeyPath struct {
	Kind  InitialIndexedDBIndexKeyPathKind `json:"kind"`
	Value []string                         `json:"value"`
}

// InitialIndexedDBIndexKeyPathKind defines model for InitialIndexedDBIndexKeyPath.Kind.
type InitialIndexedDBIndexKeyPathKind string

// InitialIndexedDBKeyPath Object-store key path. String paths contain one value; array paths contain at least one.
type InitialIndexedDBKeyPath struct {
	Kind  InitialIndexedDBKeyPathKind `json:"kind"`
	Value *[]string                   `json:"value,omitempty"`
}

// InitialIndexedDBKeyPathKind defines model for InitialIndexedDBKeyPath.Kind.
type InitialIndexedDBKeyPathKind string

// InitialIndexedDBObjectStore defines model for InitialIndexedDBObjectStore.
type InitialIndexedDBObjectStore struct {
	AutoIncrement bool                    `json:"autoIncrement"`
	Indexes       []InitialIndexedDBIndex `json:"indexes"`

	// KeyPath Object-store key path. String paths contain one value; array paths contain at least one.
	KeyPath InitialIndexedDBKeyPath  `json:"keyPath"`
	Name    string                   `json:"name"`
	Records []InitialIndexedDBRecord `json:"records"`
}

// InitialIndexedDBRecord defines model for InitialIndexedDBRecord.
type InitialIndexedDBRecord struct {
	// Key JSON-encoded structured-clone key.
	Key string `json:"key"`

	// Value JSON-encoded structured-clone value.
	Value string `json:"value"`
}

// InitialOPFSFile defines model for InitialOPFSFile.
type InitialOPFSFile struct {
	Body []byte `json:"body"`
	Path string `json:"path"`
}

// InitialStorageOrigin Profile-scoped browser storage imported for one exact HTTP origin and ancestor partition.
type InitialStorageOrigin struct {
	// AncestorOrigins Top-down HTTP origin chain for partitioned storage. Omitted for a top-level origin.
...
// InitialTargetStorageOrigin defines model for InitialTargetStorageOrigin.
...
// ProxyConfig Session egress proxy configuration. Rules are checked in order and the first match routes the connection; unmatched connections go direct, and unmatched `localhost` stays on the session host. Omitted for direct egress.
type ProxyConfig struct {
	// Bypass Legacy hosts to send direct, separated by `;` or `,`. Each entry must be a valid rule `match`; a leading `.` means any subdomain. CIDR ranges, `<local>` and scheme prefixes are rejected. Use `upstreams` and `rules`.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Bypass *string      `json:"bypass,omitempty"`
	Rules  *[]ProxyRule `json:"rules,omitempty"`

	// Tunnel Legacy tunnel endpoint for `upstream` `tunnel`; both fields are required with it. Use a tunnel URL in `upstreams`.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Tunnel *ProxyTunnelConfig `json:"tunnel,omitempty"`

	// Upstream Legacy single-upstream shape; use `upstreams` and `rules`. Cannot be combined with them. `proxy` becomes a final `*` rule via `url`, `tunnel` a `tunnel` upstream and a final `*` rule via it, each preceded by `direct` rules for the `bypass` entries. `direct` or omitted means no rules.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Upstream *ProxyConfigUpstream `json:"upstream,omitempty"`

	// Upstreams Upstreams by name. Names use lowercase letters, digits and dashes; `direct`, `refuse` and `local` are reserved.
	Upstreams *map[string]ProxyUpstream `json:"upstreams,omitempty"`

	// Url Legacy upstream proxy URL, required with `upstream` `proxy`. Use `upstreams` and `rules`.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Url *string `json:"url,omitempty"`
}

// ProxyConfigUpstream Legacy single-upstream shape; use `upstreams` and `rules`. Cannot be combined with them. `proxy` becomes a final `*` rule via `url`, `tunnel` a `tunnel` upstream and a final `*` rule via it, each preceded by `direct` rules for the `bypass` entries. `direct` or omitted means no rules.
//
// Deprecated: this type has been marked as deprecated upstream, but no `x-deprecated-reason` was set
type ProxyConfigUpstream string

// ProxyRule Routes the browser connections its match covers.
type ProxyRule struct {
	// Match `host` or `host:port`, where the host is exact, `*.suffix` for subdomains, or `*` for any host. `*` never matches `localhost`, which only a rule naming it routes. Loopback IPs never reach the proxy, so local services are matched as `localhost`.
	Match string `json:"match"`

	// Via `direct` dials from the session host, `refuse` fails the connection, `local` uses the attached local tunnel and fails while none is attached. Anything else names an upstream, or is an inline proxy URL without a secret.
	Via string `json:"via"`
}

// ProxyTunnelConfig Legacy tunnel endpoint for `upstream` `tunnel`; both fields are required with it. Use a tunnel URL in `upstreams`.
//
// Deprecated: this type has been marked as deprecated upstream, but no `x-deprecated-reason` was set
type ProxyTunnelConfig struct {
	// Auth Bearer secret for the tunnel handshake. Write-only; never returned.
	Auth *string `json:"auth,omitempty"`

	// Url Compound tunnel URL (`ws+yamux+socks5://` or `wss+yamux+socks5://`).
	Url *string `json:"url,omitempty"`
}

// ProxyUpstream A named upstream that proxy rules route through.
type ProxyUpstream struct {
	// Auth Bearer secret for a tunnel URL's handshake. Required for a tunnel URL and invalid for a proxy URL. Write-only; never returned.
	Auth *string `json:"auth,omitempty"`

	// Url A generic proxy URL (`http`, `https`, `socks`, `socks5`, `socks5h`) or a compound tunnel URL (`ws+yamux+socks5://`, `wss+yamux+socks5://`). Proxy credentials go in the userinfo (`socks5://user:pass@host:1080`) and are sent as Basic `Proxy-Authorization` for `http`/`https` or RFC 1929 username/password for the socks schemes. An omitted port defaults to 1080 (socks), 80 (http) or 443 (https).
	Url string `json:"url"`
}
...
type Session struct {
	...
	// Proxy Stored session egress proxy configuration. Secrets are write-only, so this value cannot be replayed as a write.
...
// SessionProxy Stored session egress proxy configuration. Secrets are write-only, so this value cannot be replayed as a write.
type SessionProxy struct {
	// Bypass Legacy `;`-separated matches of the leading `direct` rules. Only present with an exact `proxy` or `tunnel` value.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Bypass *string     `json:"bypass,omitempty"`
	Rules  []ProxyRule `json:"rules"`

	// Tunnel Legacy tunnel endpoint. Only present when `upstream` is exactly `tunnel`. The secret is never returned.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Tunnel *struct {
		Url *string `json:"url,omitempty"`
	} `json:"tunnel,omitempty"`

	// Upstream Legacy single-upstream view of `rules`; read `upstreams` and `rules` instead. Exact when the rules are optional leading `direct` rules followed by one final `*` rule via an upstream proxy or tunnel, with no other upstreams, and `direct` when there are no rules. Otherwise it approximates the route of the last `*` rule (`local` reads as `tunnel`, `refuse` as `direct`), or `direct` without one, and `url`, `tunnel` and `bypass` are omitted.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Upstream  SessionProxyLegacyUpstream      `json:"upstream"`
	Upstreams map[string]SessionProxyUpstream `json:"upstreams"`

	// Url Legacy upstream proxy URL with its password masked. Only present when `upstream` is exactly `proxy`.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Url *string `json:"url,omitempty"`
}

// SessionProxyLegacyUpstream Legacy single-upstream view of `rules`; read `upstreams` and `rules` instead. Exact when the rules are optional leading `direct` rules followed by one final `*` rule via an upstream proxy or tunnel, with no other upstreams, and `direct` when there are no rules. Otherwise it approximates the route of the last `*` rule (`local` reads as `tunnel`, `refuse` as `direct`), or `direct` without one, and `url`, `tunnel` and `bypass` are omitted.
//
// Deprecated: this type has been marked as deprecated upstream, but no `x-deprecated-reason` was set
type SessionProxyLegacyUpstream string

// SessionProxyUpstream A named upstream as stored. The secret is never returned and proxy URL passwords are masked.
type SessionProxyUpstream struct {
	Url string `json:"url"`
}
...
// UpdateProxyConfig Replacement session egress proxy configuration. Fields other than `drain` are as in `ProxyConfig`.
type UpdateProxyConfig struct {
	// Bypass Legacy hosts to send direct; use `upstreams` and `rules`.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Bypass *string `json:"bypass,omitempty"`

	// Drain Reset live tunnel streams instead of letting them drain. New connections use the new rules either way.
	...
	// Upstream Legacy single-upstream shape; use `upstreams` and `rules`.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Upstream  *UpdateProxyConfigUpstream `json:"upstream,omitempty"`
	Upstreams *map[string]ProxyUpstream  `json:"upstreams,omitempty"`

	// Url Legacy upstream proxy URL; use `upstreams` and `rules`.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Url *string `json:"url,omitempty"`
}

// UpdateProxyConfigUpstream Legacy single-upstream shape; use `upstreams` and `rules`.
//
// Deprecated: this type has been marked as deprecated upstream, but no `x-deprecated-reason` was set
type UpdateProxyConfigUpstream string
...
type CreateSessionParams struct {
	// WaitForReady Wait for browser startup and state restoration before returning. Defaults to true.
	WaitForReady *bool `form:"waitForReady,omitempty" json:"waitForReady,omitempty"`
...
// UpdateSessionProxyParams defines parameters for UpdateSessionProxy.
type UpdateSessionProxyParams struct {
	// XApertureTenantId Tenant selected for a tenant-scoped operation. System administrators and account sessions may provide this header. A tenant API token uses its bound tenant and may omit the header; selecting a different tenant is forbidden.
	XApertureTenantId *SelectedTenantId `json:"X-Aperture-Tenant-Id,omitempty"`
}
...
type UpdateSessionProxyJSONRequestBody = UpdateProxyConfig
...
type ClientInterface interface {
	...
	// UpdateSessionProxyWithBody Replace browser session proxy configuration
	//
	...
	UpdateSessionProxyWithBody(ctx context.Context, sessionId SessionId, params *UpdateSessionProxyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	// UpdateSessionProxy Replace browser session proxy configuration
	//
	// Replaces the session egress proxy configuration. The change applies to new connections; existing connections keep their route unless `drain` resets live tunnel streams. Secrets are write-only — tunnel auth is never returned and proxy URL passwords come back masked.
	//
	// Takes a body of the `application/json` content type.
...
//
// Corresponds with PUT /api/sessions/{sessionId}/proxy (the `UpdateSessionProxy` operationId).
func (c *Client) UpdateSessionProxyWithBody(ctx context.Context, sessionId SessionId, params *UpdateSessionProxyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateSessionProxyRequestWithBody(c.Server, sessionId, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewCreateSessionRequestWithBody(server string, params *CreateSessionParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.WaitForReady != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "waitForReady", *params.WaitForReady, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "boolean", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
// NewUpdateSessionProxyRequest calls the generic UpdateSessionProxy builder with application/json body
func NewUpdateSessionProxyRequest(server string, sessionId SessionId, params *UpdateSessionProxyParams, body UpdateSessionProxyJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateSessionProxyRequestWithBody(server, sessionId, params, "application/json", bodyReader)
}

// NewUpdateSessionProxyRequestWithBody constructs an http.Request for the UpdateSessionProxy method, with any body, and a specified content type
func NewUpdateSessionProxyRequestWithBody(server string, sessionId SessionId, params *UpdateSessionProxyParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/sessions/%s/proxy", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// UpdateSessionProxyWithBodyWithResponse Replace browser session proxy configuration
	//
	// Replaces the session egress proxy configuration. The change applies to new connections; existing connections keep their route unless `drain` resets live tunnel streams. Secrets are write-only — tunnel auth is never returned and proxy URL passwords come back masked.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with PUT /api/sessions/{sessionId}/proxy (the `UpdateSessionProxy` operationId).
	UpdateSessionProxyWithBodyWithResponse(ctx context.Context, sessionId SessionId, params *UpdateSessionProxyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateSessionProxyResponse, error)

	// UpdateSessionProxyWithResponse Replace browser session proxy configuration
	//
	// Replaces the session egress proxy configuration. The change applies to new connections; existing connections keep their route unless `drain` resets live tunnel streams. Secrets are write-only — tunnel auth is never returned and proxy URL passwords come back masked.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
...
type UpdateSessionProxyResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	// JSON200 the response for an HTTP 200 `application/json` response
	JSON200 *SessionMutation
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r UpdateSessionProxyResponse) GetJSON200() *SessionMutation {
	return r.JSON200
}

// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r UpdateSessionProxyResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r UpdateSessionProxyResponse) GetBody() []byte {
	return r.Body
}

// Status returns HTTPResponse.Status
func (r UpdateSessionProxyResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdateSessionProxyResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r UpdateSessionProxyResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
//
// Corresponds with PUT /api/sessions/{sessionId}/proxy (the `UpdateSessionProxy` operationId).
func (c *ClientWithResponses) UpdateSessionProxyWithBodyWithResponse(ctx context.Context, sessionId SessionId, params *UpdateSessionProxyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateSessionProxyResponse, error) {
	rsp, err := c.UpdateSessionProxyWithBody(ctx, sessionId, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
//
// Corresponds with PUT /api/sessions/{sessionId}/proxy (the `UpdateSessionProxy` operationId).
func (c *ClientWithResponses) UpdateSessionProxyWithResponse(ctx context.Context, sessionId SessionId, params *UpdateSessionProxyParams, body UpdateSessionProxyJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateSessionProxyResponse, error) {
	rsp, err := c.UpdateSessionProxy(ctx, sessionId, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateSessionProxyResponse(rsp)
...
// ParseUpdateSessionProxyResponse parses an HTTP response from a UpdateSessionProxyWithResponse call
func ParseUpdateSessionProxyResponse(rsp *http.Response) (*UpdateSessionProxyResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdateSessionProxyResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
func (siw *ServerInterfaceWrapper) CreateSession(c *gin.Context) {
	...
	// ------------- Optional query parameter "waitForReady" -------------

	err = runtime.BindQueryParameterWithOptions("form", true, false, "waitForReady", c.Request.URL.Query(), &params.WaitForReady, runtime.BindQueryParameterOptions{Type: "boolean", Format: ""})
	if err != nil {
		siw.ErrorHandler(c, fmt.Errorf("Invalid format for parameter waitForReady: %w", err), http.StatusBadRequest)
		return
	}
...
// UpdateSessionProxy operation middleware
func (siw *ServerInterfaceWrapper) UpdateSessionProxy(c *gin.Context) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params UpdateSessionProxyParams
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.PUT(options.BaseURL+"/api/sessions/:sessionId/proxy", wrapper.UpdateSessionProxy)
...
type UpdateSessionProxyRequestObject struct {
	SessionId SessionId `json:"sessionId"`
	Params    UpdateSessionProxyParams
	Body      *UpdateSessionProxyJSONRequestBody
}

type UpdateSessionProxyResponseObject interface {
	VisitUpdateSessionProxyResponse(w http.ResponseWriter) error
}

type UpdateSessionProxy200JSONResponse SessionMutation

func (response UpdateSessionProxy200JSONResponse) VisitUpdateSessionProxyResponse(w http.ResponseWriter) error {
...
type UpdateSessionProxydefaultJSONResponse struct {
	Body       Error
	StatusCode int
}

func (response UpdateSessionProxydefaultJSONResponse) VisitUpdateSessionProxyResponse(w http.ResponseWriter) error {
...
// UpdateSessionProxy operation middleware
func (sh *strictHandler) UpdateSessionProxy(ctx *gin.Context, sessionId SessionId, params UpdateSessionProxyParams) {
	var request UpdateSessionProxyRequestObject

	request.SessionId = sessionId
	request.Params = params

	var body UpdateSessionProxyJSONRequestBody
	if err := ctx.ShouldBindJSON(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(ctx, err)
		return
	}
	...
	handler := func(ctx *gin.Context, request interface{}) (interface{}, error) {
		return sh.ssi.UpdateSessionProxy(ctx, request.(UpdateSessionProxyRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "UpdateSessionProxy")
	}
	...
	if err != nil {
		sh.options.HandlerErrorFunc(ctx, err)
	} else if validResponse, ok := response.(UpdateSessionProxyResponseObject); ok {
		if err := validResponse.VisitUpdateSessionProxyResponse(ctx.Writer); err != nil {
			sh.options.ResponseErrorHandlerFunc(ctx, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(ctx, fmt.Errorf("unexpected response type: %T", response))
...
var swaggerSpec = []string{
	"7L19c9s4ljf6VVDap2peVpLlTtI97dTUXsdOeryTdLK207O13XksiIQktCmCTYC2NalU3Q9xv8v9/36U",
	"+0mewjkACJIgRcmy0+np3ZoZRwRBvJxzcHBefufjIBKrTKQsVXJw9HGQ0ZyumGI5/OukyKXI9V8xk1HO",
	"M8VFOjgavM3oLwUj05TdKWwzJfNcrIhaMpLl7IaLQpKMLtiYnLNCMsIVEWmyJrdcLaGVpCtGRMZyqvsk",
	"NI3JnCf6w+PBcMDu6CpL2OBowNb/+XO0+mEZf/fD9X/993/xt/xs/eb07KvXl8dPXl++fPLD6cv125+P",
	"b/V//sHP5NkquT77WfA3py+f/c/P+v+P1ZvT49s3J5Mn+n9fXy5u35ya37z/nKWTwXDA9ex+KVi+HgwH",
	"KV3pEUS4CMOBjJZsRfVqqHWmn0iV83Qx+PRpODhlCVMsbi7VBUtYpAiNFL9hJGdSFHnE5JDE+Eb5EyzQ",
	"kIiczIRajsnlkpGYzWmRKMIlmWIX03HLME1/lXGa1wdHA3xZr2xarAZHP5Y/lO/RJBl8GAYmd5ZGSRGz",
	"1jma50SKuRrZeUkmJRepJLdLlpKpygs2bU5qThPZPide/XBwatCDG/VMiITRFIb9mi1otA4NPstZROFf",
	"eljD2nTwPSJvuYo0sVJFzECk3UdNrs0NrMz0bJGKnMXmR9N4qictiyxLOIufa1aZs9w9/StNkodaC77i",
	"qrlz5+yXgkk9C82sRPJ/sjF5u+JK/yRyMp1MSSGZJM8mY/IDTQq9BDNxw8jhZEJozgiNIpbp1rNCkSih",
	"q4zFRAn9vMLIzybhaSUwsOBs9CsrnvKVptiJmxZPFVuwHKZ1ziKRxzxdnAXI8v37s1PCY5YqPucsJzlT",
	"RZ7aLdFCKLevE6lorljsFj+jalkOMvc+Mxzk7JeC5yX1lEOfi3xFNbsVBdctm6x0zm7ENYtfgajbJC2U",
	"uGapHJIcXzL/rssJ2C49BxC+Vn5rQtPjvKEJS5XekWkXdZlPtEmPJAmJjvKlVtGBE2LxJUtpqkK7hE+I",
	"NA3JXOSEEgW/jmQkND25c2JMLtZSsRWhsaYMqXKqRC6BH2kUiQJ6MoJnRdcky8UNjxlRSy7JktGY5WNy",
