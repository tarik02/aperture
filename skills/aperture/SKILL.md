...
Playwright tools are selected when the MCP connection is established with the `playwrightTools` query parameter:

```text
/mcp?playwrightTools=core,vision,network
/sessions/$SESSION_ID/mcp?playwrightTools=core,vision
```
