...
// EmbedRoot is the stable production build output path relative to apps/web/.
...
// Run `pnpm build` in apps/web/ before building Go; the build fails if assets are missing.
