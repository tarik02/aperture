...
Pushes to `master` that touch the docs, the packages or the OpenAPI spec deploy the site to [GitHub Pages](https://tarik02.github.io/aperture). Each Aperture instance also serves its own API reference at `/docs`.
